            ...
            <div class="bg-purple-600 rounded">
              ...
              >
                ...
                <tbody class="bg-purple-100 cursor-pointer">
                  <tr
                    class=""
                    v-for="lottoResult in lottoResults"
                    :key="lottoResult._id"
                  >
                    <td>{{ getRound(lottoResult) }}</td>
                    <td>
                      <span
                    ...
                    <td>
                      <button type="button">
                        <nuxt-link
                          :to="`/markets/results/new/${lottoResult._id}`"
                        >
                          <button
                      ...
                      <button type="button">
                        <nuxt-link :to="`/markets/trends/${lottoResult._id}`">
                          <div
                            class="bg-blue-500 flex items-center px-3 py-2 rounded hover:bg-blue-700"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              height="24px"
