<template>
  <div class="tag-input flex flex-wrap">
    <select
    ...
    >
      ...
      <option v-for="market in markets" :key="market._id" v-bind:value="market">
        {{ market.name }}
      </option>
    </select>
    <div v-for="(tag, index) in tags" :key="tag._id" class="tag-input__tag">
